    ...
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update member_master_tbl set full_name=@full_name, dob=@dob, contact_no=@contact_no, email=@email, password=@password, account_status=@account_status WHERE user_id='" + Session["username"].ToString().Trim() + "'", con);
